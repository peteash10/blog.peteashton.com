...
5. Develop [Photo School](http://photo-school.co.uk). This is the closest I come to running a business, but it's always worked in a very reactive way. I schedule classes and bookings come it via word of mouth and Google. Occasionally a business will hire me for a bigger job but it's always their initiative. After five years I've never really found the time to push it to the next level and there's a real sense that I'm leaving easy money on the table. Photo School is currently brings in a quarter to a third of my income. I need to get that higher, while keeping it on my terms, run in the way that makes me happy (and it really does make me happy). 
